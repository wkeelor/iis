                ...
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    @if($curr_user->role_id == 3)
                        <li class="flex items-center">
                            <a href="{{ route('all_users') }}" class="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Užívatelia</a>
                        </li>
                    @endif
                    <li class="flex items-center">
                    ...
                    <li class="flex items-center">
                        <a href="{{ route('basket',['user' => $curr_user->id]) }}" class="flex items-center justify-center hover:bg-gray-100 md:hover:bg-transparent md:p-0 dark:hover:bg-gray-700 md:dark:hover:bg-transparent dark:border-gray-700 p-2" style="color: white;">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700 dark:divide-gray-600" id="user-dropdown">
                            ...
                            <ul class="py-4" aria-labelledby="user-menu-button">
                                <li>
                                    ...
                                    <button data-modal-target="edit-modal" data-modal-toggle="edit-modal" data-modal-params='{"user": @json($curr_user)}' onclick="openEditModal(event)" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">
                                        <i class="fa-solid fa-user-pen hover:text-blue-700 dark:hover:text-blue-500"></i>
                                        <span>Upraviť osobné údaje</span>
                                    </button>
