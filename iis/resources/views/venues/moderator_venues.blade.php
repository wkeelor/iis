<x-layout>
    @php($titles = ['Schválené', 'Čakajúce', 'Zamietnuté'])
    @for($i = 0; $i < 3; $i++)
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex space-x-4">
                                        @if($venue)
                                            <a href="{{ route('edit_venues_show', ['venue' => $venue]) }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 dark:hover:text-white">
                                                <i class="fa-solid fa-pen-to-square hover:text-blue-700 dark:hover:text-blue-500" ></i>
                                            </a>
                                            @if(!$venue->approved)
                                                <a href="{{ route('venue_approve', ['venue' => $venue]) }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 dark:hover:text-white">
                                                    <i class="fa-solid fa-square-check text-green-400 hover:text-green-500 dark:hover:text-green-600"></i>
                                                </a>
                                            @endif
                                            @if(is_null($venue->approved) || $venue->approved)
                                                <a href="{{ route('venue_decline', ['venue' => $venue]) }}" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 dark:hover:text-white">
