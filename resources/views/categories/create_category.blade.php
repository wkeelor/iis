        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 p-8"> <!-- Added padding -->
            ...
            <div>
                <form action="{{route('add_category')}}" method="POST">
                    ...
                    <div class="mb-8"> <!-- Increased margin-bottom for more space -->
                        <label for="parent_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Rodičovská kategorie</label>
                    ...
                    <div class="flex items-center mb-4">
                        <input id="approved" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                        <label for="approved" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Schváleno</label>
                    </div>
